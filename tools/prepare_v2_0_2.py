...
def update_public_docs() -> None:
    ...
    if "## v2.0.2 public-readiness hotfix" not in stable:
        ...
        section = (
            ...
            "The native Python bridge joins the Purple Dragon protected surface, bringing the final publisher-signed manifest to 69 protected files.\n\n"
        )
